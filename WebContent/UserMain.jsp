  ...
  nav, article {
    ...
    <body>
        ...
        <nav>
        	...
        	<%=session.getAttribute("lId") %>
            <input name="Info" type="submit" class="btn btn-dark" style="background-color:black" value="회원정보">
            </form>
            &nbsp;&nbsp;
            <button onclick="location.href='LogoutForm.jsp'" type="button" class="btn btn-dark" style="background-color:black" value="로그아웃">로그아웃</button>
            </div>
      ...
      <section>
        <aside>
            <br><br>
             <h4><a href="#"style='color:white'>리그오브레전드</a> </h4><br>
            <h4><a href="#"style='color:white'>오버워치</a> </h4><br>
            <h4><a href="#"style='color:white'>로스트아크</a> </h4><br>
            <br><hr><br>
            <h4><a href="bbs.jsp"style='color:white'>자유게시판</a> </h4><br>
            <br><br><br>
        ...
        <article>
          <div class="card-columns">
           ...
           <div class="card">
              <a href="https://www.wowtv.co.kr/NewsCenter/News/Read?articleId=A202112100232&t=NN" style="color:white"> <img class="card-img-top" src="https://img.wowtv.co.kr/wowtv_news/dnrs/20211210/B20211210144858410.jpg" alt="Card image cap"></a>
              <div class="card-body">
            ...
            <div class="card">
             <a href="https://www.fomos.kr/esports/news_view?lurl=%2Fesports%2Fnews_list%3Fnews_cate_id%3D13&entry_id=106459" style="color:black"> <img class="card-img-top" src="http://www.kukinews.com/data/kuk/image/2021/12/20/kuk202112200056.680x.0.png" alt="Card image cap"></a>
              <div class="card-body">
                <h5 class="card-title"><a href="https://www.fomos.kr/esports/news_view?lurl=%2Fesports%2Fnews_list%3Fnews_cate_id%3D13&entry_id=106459" style="color:white">‘풀배 맹활약’, ‘롤 더 넥스트’, D조 우승으로 마무리</h5>
