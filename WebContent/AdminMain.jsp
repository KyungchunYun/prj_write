...
<!Doctype html>
<% if(session.getAttribute("lId") == null || session.getAttribute("Acode") == null){ %>
	<script>
...
@media (max-width: 600px) {
  nav, article {
    ...
    <body>
        ...
        <header>
            <h1 id="heading"><a href="Home_Main.jsp" style="color:white">코드:꾼스트 게임뉴스</a></h2>
          </header>
        ...
        <nav>
        	<div class="btn-group">
            &nbsp;&nbsp;
            <button type="button" onclick="location.href='LogoutForm.jsp'" class="btn btn-dark" style="background-color:black">로그아웃</button>
            </div>
        </nav>
