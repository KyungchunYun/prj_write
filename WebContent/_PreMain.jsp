...
<html>
    ...
    <body>
      ...
      <header>
        <h1 id="heading"><a style="color:white">코드:꾼스트 게임뉴스</a></h2>
      </header>
      ...
      <nav>
        ...
        <div class="jumbotron" id="jumbo">
            ...
            <p class="leadd">
              <a class="btn btn-dark" href="LoginForm.jsp" role="button">로그인</a> &nbsp;&nbsp;
              <a class="btn btn-dark" href="Create_Ac_Main.jsp" role="button">회원가입</a>             
            </p>
        </div>
		        <br><hr><br>
